...
vector<nnode> node ;
vector<vector<double>> transition_time,acc_maxdelay , capacitance , delay ,acc_mindelay     ;  
vector<vector<bool>> valid_node ,node_rise; 
vector<vector<string>> ans_delay   ,in_max , in_min ;
