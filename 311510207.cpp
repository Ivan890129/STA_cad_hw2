...
vector<nnode> node ;
vector<vector<double>> transition_time,acc_maxdelay , capacitance , delay  ;  // capacitance[i] is delay of node i  // acc_delay為該節點的最前端
vector<vector<bool>> valid_node ,node_rise; // true: the node has been caculated 
vector<vector<string>> ans_delay  , ans_maxdelay ;
...
int main(int argc, char* argv[])
{
    ...
    ofstream txt_delay ,txt_capacitance,txt_max_delay , txt_gate; 
    string line;
    string str ; 
    char ch;
    int num  ; 
